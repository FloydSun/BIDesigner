...
import org.saiku.web.service.report.handlers.ContextHandlers;
import org.saiku.web.service.report.handlers.RequestContextHandler;
import org.saiku.web.service.report.handlers.UtilContextHandler;
...
public class ReportServiceImpl implements ReportService, Scheduler {
    ...
    public void init() throws Exception {
        String resPath = PathUtil.getClassRoot() + "components/";
        String dsConfigPath = PathUtil.getClassRoot() + "datasource.xml";
